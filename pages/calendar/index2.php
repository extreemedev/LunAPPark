  ...
  <div class="row2">
    ...
    <div class="column2" style="align-items: center; width: 100%;">
      <div class="card2 text">
        ...
        <br>
        <p>In questa sezione trovi il <b>listino prezzi</b> completo per ogni tipo di esigenza!</p>
        <p>Scoprili subito!</p>
        <hr>
        <p>
          <table>
            ...
            <tr>
              <td>Ridotto<br>(Bimbo fino ai 7 anni)</td>
              <td style="text-align: center;">10.00 €</td>
              <td style="text-align: center;">15.00 €</td>
            </tr>
            <tr>
              <td>Serale (valido dalle 17:00)</td>
