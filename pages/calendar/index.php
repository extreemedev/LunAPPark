<html>
    <head>
        ...
        <title>Calendario e tariffe</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="nav__links navbar-nav ms-auto">
                        ...
                        <li class="nav-item border-bottom border-warning"><a class="nav-link" href="#">Calendario e tariffe + hotel</a></li>
                        <li class="nav-item"><a class="nav-link" href="/pages/info/index.html">Info e contatti</a></li>
                        <li class="nav-item"><a class="nav-link" href="../login/index.php">Area personale</a></li>
                    </ul>
