<body id="page-top" class="back5" onload="<?php if(TITLE=="Area personale" and $_SESSION["load"]==0){echo "myLoader()"; $_SESSION["load"]=1; } elseif($_GET['valid'] == "ok"){echo "myLoader()";} elseif($_GET["buy"] == "ok"){echo "myLoader()";}?>">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav__links navbar-nav ms-auto">
                    ...
                    <li class="nav-item" style="<?php if(TITLE=="Registrazione"){echo "display:none;";}?>"><a class="nav-link <?php if(TITLE=="Calendario e tariffe"){echo "border-bottom border-warning";}?>" href="/pages/calendar/index.php">Calendario e tariffe</a></li>
