        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav__links navbar-nav ms-auto">
                    ...
                    <li class="nav-item" style="<?php if(TITLE=="Registrazione"){echo "display:none;";}?>"><a class="nav-link <?php if(TITLE=="Area personale" or TITLE=="Registrazione"){echo "border-bottom border-warning";}?>" href="/pages/login/index.php">Area personale</a></li>
